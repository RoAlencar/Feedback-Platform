...
-- ============================================================
INSERT INTO
    students (id, name, email, is_active)
VALUES
    (
        '11111111-1111-1111-1111-111111111111',
        'Ana Souza',
        'ana.souza@fiap.com.br',
        TRUE
    ),
    (
        '22222222-2222-2222-2222-222222222222',
        'Bruno Lima',
        'bruno.lima@fiap.com.br',
        TRUE
    ),
    (
        '33333333-3333-3333-3333-333333333333',
        'Carla Mendes',
        'carla.mendes@fiap.com.br',
        TRUE
    ),
    (
        '44444444-4444-4444-4444-444444444444',
        'Diego Oliveira',
        'diego.oliveira@fiap.com.br',
        TRUE
    ),
    (
        '55555555-5555-5555-5555-555555555555',
        'Fernanda Alves',
        'fernanda.alves@fiap.com.br',
        TRUE
